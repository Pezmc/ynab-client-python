...
class CategoriesApi(object):
    ...
    def get_categories(self, budget_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_categories(budget_id, _async=True)
        >>> result = thread.get()
    ...
    def get_categories_with_http_info(self, budget_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async=True
        >>> thread = api.get_categories_with_http_info(budget_id, _async=True)
        >>> result = thread.get()
    ...
    def get_category_by_id(self, budget_id, category_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async=True
        >>> thread = api.get_category_by_id(budget_id, category_id, _async=True)
        >>> result = thread.get()
    ...
    def get_category_by_id_with_http_info(self, budget_id, category_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async=True
        >>> thread = api.get_category_by_id_with_http_info(budget_id, category_id, _async=True)
        >>> result = thread.get()
